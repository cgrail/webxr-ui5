sap.ui.define(["sap/ui/model/Context", "../../js/QuickTemplates/QuickActionBaseController", "../../js/QuickTemplates/AnnotationHelper", "../../js/QuickTemplates/ODataModelHelper", "sap/ui/model/json/JSONModel"], function(Context, BaseController, AnnotationHelper, ODataModelHelper, JSONModel) {
	"use strict";
